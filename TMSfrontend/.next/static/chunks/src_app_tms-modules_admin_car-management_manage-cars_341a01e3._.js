(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_tms-modules_admin_car-management_manage-cars_341a01e3._.js", {
...
_s(CarForm, "hxxbeTIW8Yv5Z/F4m3sN6xsq8ZI=", false, function() {
    return [
...
function ManageCars() {
    ...
    const handleAddCar = async (newCar)=>{
        try {
            setIsSubmitting(true);
            const { success } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tms$2d$modules$2f$admin$2f$car$2d$management$2f$manage$2d$cars$2f$api$2f$carServices$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createCar"])(newCar);
            if (success) {
    ...
    const handleUpdateCar = async (updatedCar)=>{
        try {
            setIsSubmitting(true);
            const { success } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tms$2d$modules$2f$admin$2f$car$2d$management$2f$manage$2d$cars$2f$api$2f$carServices$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateCar"])(updatedCar.id, updatedCar);
            if (success) {
    ...
    const handleDeleteCar = async (id)=>{
        ...
        if (result.isConfirmed) {
            try {
                const { success } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tms$2d$modules$2f$admin$2f$car$2d$management$2f$manage$2d$cars$2f$api$2f$carServices$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteCar"])(id);
                if (success) {
...
//# sourceMappingURL=src_app_tms-modules_admin_car-management_manage-cars_341a01e3._.js.map